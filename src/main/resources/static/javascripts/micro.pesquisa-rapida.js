...
Efinderi.PesquisaRapidaCliente = (function() {
	...
	function onPesquisaRapidaClicado(event) {
		...
		$.ajax({
			...
			data : {
				confirmacao : this.nomeInput.val()
			},
	...
	function onPesquisaConcluida(resultado) {
		...
		this.pesquisaRapidaClientesModal.close();
...
$(function() {
	var pesquisaRapidaCliente = new Efinderi.PesquisaRapidaCliente();
